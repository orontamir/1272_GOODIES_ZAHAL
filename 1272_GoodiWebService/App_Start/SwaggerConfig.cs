...
namespace _1272_GoodiWebService
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "_1272_GoodiWebService");
        ...
        private static string GetXmlCommentsPath()
        {
            ...
            var binFilePath = Path.Combine(baseDirectory, "App_Data");
